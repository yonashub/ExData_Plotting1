...
plot(datetime, as.numeric(dateData$Sub_metering_1), type="l", ylab="Energy sub metering", xlab="")
lines(datetime, as.numeric(dateData$Sub_metering_2), type="l", col="red")
lines(datetime, as.numeric(dateData$Sub_metering_3), type="l", col="blue")
